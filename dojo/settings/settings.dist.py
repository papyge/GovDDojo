...
HASHCODE_ALLOWED_FIELDS = ['shortMsg', 'title', 'cwe', 'vulnerability_ids', 'line', 'file_path', 'component_name', 'component_version', 'description', 'endpoints', 'unique_id_from_tool', 'severity', 'vuln_id_from_tool']
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    'Wordfence': DEDUPE_ALGO_HASH_CODE,
